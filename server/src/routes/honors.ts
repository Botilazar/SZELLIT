...
const giveHonorHandler: RequestHandler = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: "Honor given", totalHonors: parseInt(countRes.rows[0].total) });
    } catch (err) {
...
const removeHonorHandler: RequestHandler = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: "Honor removed", totalHonors: parseInt(countRes.rows[0].total) });
    } catch (err) {
